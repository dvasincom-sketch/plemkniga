  ...
  fields: [
    ownerOrgField,
    {
      ...
      fields: [
        ...
        {
          /*
           * Лактация, идущая на день замера: число состоявшихся отёлов.
           * Колонка называется так же, как у осеменений, но значит другое —
           * там отёл, которого ещё не было. Разбор — в `Inseminations.ts`.
           */
          ...
          admin: {
            description:
              'Лактация, идущая на день замера, — она же число состоявшихся отёлов. ' +
              'Пусто — система возьмёт их количество сама',
          },
        },
      ],
    },
