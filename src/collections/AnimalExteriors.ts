...
export const AnimalExteriors: CollectionConfig = {
  ...
  fields: [
      ...
      fields: [
        {
           ...
           * и расхождение между бонитёрами — известная величина, которую
           * без имени человека не измерить.
           *
           * Человек здесь всегда бонитёр, а «оценщик» — только организация
           * в поле рядом. Пока обоих звали оценщиком, «расхождение между
           * оценщиками» читалось то про людей, то про хозяйства.
           */
          name: 'assessor',
          type: 'relationship',
        ...
        },
        {
           ...
           * бонитёрами — известная величина, и меряется она по людям;
    ...
    },
    {
       ...
       *
       * В подписи два числа, и они не спорят: −2…+2 — рабочий размах,
       * по которому нарисованы шкалы, ±3 — граница приёма. Рамка по размаху
       * отвергала бы настоящее отклонение рекордиста как ошибку, поэтому
       * названы обе, а не одна.
       */
      type: 'collapsible',
      label: 'Композиты (отклонение, обычно −2…+2, принимается до ±3)',
      fields: [
