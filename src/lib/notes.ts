...
export const NOTES: Note[] = [
  ...
  },
  {
    ...
    title: 'Надёжность оценки: откуда берётся 0,91 и чего она не значит',
    lead:
      'Рядом с племенной ценностью быка стоит второе число, и читают его неверно чаще, ' +
      'чем верно. Разбираем, как надёжность считается по числу дочерей, почему она ' +
      'не точность и не вероятность, и сколько дочерей нужно, чтобы числу можно было верить.',
    date: '2026-09-04',
    author: NOTE_AUTHOR,
    authorUrl: NOTE_AUTHOR_URL,
    passport: [
      { label: 'Что разбирается', value: 'Надёжность оценки быка по потомству, R' },
