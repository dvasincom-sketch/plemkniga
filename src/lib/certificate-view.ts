 ...
 */
/**
 * Подписи вывода ДНК-теста — те же слова, что в карточке.
 *
 * Список короткий и потому повторён здесь, а не импортирован из описания
 * коллекции: `Animals.ts` собирает конфигурацию Payload, и тянуть её
 * в сборщик бумаги значило бы завести зависимость документа от админки.
 * Расхождение видно на первом же выпущенном бланке — подписи стоят
 * рядом на экране и на бумаге.
 */
