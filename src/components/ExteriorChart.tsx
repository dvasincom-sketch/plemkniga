...
function ScaleHead({ middle }: { middle?: boolean }) {
  return (
    <thead className="max-sm:hidden">
      ...
      {/*
         Деления подписаны цифрами на обеих шкалах.

         У признаков с оптимумом посередине ноль был подписан словом
         «оптимум» — по мысли верной: слово говорит, что это значение
         и есть лучшее, а цифра только отмечает шкалу. Но слово вшестеро
         длиннее цифры, и, поставленное по центру нулевой отметки, оно
         накрывало собой соседние −1 и +1. Шкала теряла два деления
         из пяти, то есть подпись прятала ровно то, что подписывала.

         Смысл никуда не делся: он в заголовке колонки — «Отклонение
         от оптимума», — и в абзаце над таблицей. Там для него есть
         место, а внутри шкалы его нет.
      */}
