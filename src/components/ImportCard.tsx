            ...
            <div className="mt-4 space-y-3">
              ...
              */}
              ...
              {/*
                 ...
                 Они принимаются в набор «Животные» уже сегодня, и это
                 работает — но узнать об этом было неоткуда: человек видит
                 список наборов, где ФГИАС не упомянут, и делает вывод,
                 что надо перекладывать в наш формат. То есть делает
                 работу дважды из-за отсутствия одной фразы.
              */}
              {kind === 'animals' && (
                <p className="text-[13px] leading-snug text-ink-700">
                  Файл по шаблону ФГИАС ПР можно грузить как есть — перекладывать в наш формат
                  не нужно.
                  <span className="mt-0.5 block text-ink-500">
                    Книга узнаёт «Основные сведения» и берёт оттуда то, что ведёт: номера, кличку,
                    дату рождения, породу, линию, масть, назначение, кровность. Остальные колонки
                    реестра она не хранит и назовёт их в отчёте. Так же грузится и обратный файл
                    ФГИАС — базовые номера разложатся по карточкам.
                  </span>
                </p>
              )}
