  ...
  return (
    <span className={`inline-flex items-center gap-2 text-[15px] leading-none ${className}`}>
      ...
      <InfoTip label="Что означает уровень достоверности">
        ...
        <p className="mb-3">
          Показывает, кем проверена запись. Племенное свидетельство выпускается только для
          записей, верифицированных Ассоциацией; в расчёты индексов запись попадает начиная
          с подтверждения лабораторией.
        </p>
