 ...
 * до записи, верифицированной Ассоциацией. От уровня зависит одно —
 * можно ли выпускать племенное свидетельство. В аналитику запись
 * попадает независимо от уровня: отбора по нему в расчётах нет
 * и не было, о чём сказано и в подсказке ниже. Шапка утверждала
 * обратное, и получалось, что файл спорит сам с собой.
 *
