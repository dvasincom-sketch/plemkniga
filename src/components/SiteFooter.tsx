...
export async function SiteFooter() {
  ...
  return (
    ...
    >
      ...
      {/*
         Нижняя строка — только правовые документы Ассоциации.

         Здесь по очереди стояли подпись разработчика и имя организации,
         содержащей платформу, и обе убраны по одной причине. Подвал книги
         отвечает на вопрос «чья это книга», а не «на чём она сделана».
         Хозяйство, читающее книгу голштинской ассоциации, встречало
         в подвале третье лицо и должно было само догадаться, кто кому кем
         приходится, — а неверная догадка здесь дороже отсутствующей
         строки: сегодня это выглядит как совладелец данных.

         Кто содержит систему, сказано на витрине, где об этом и спрашивают.
      */}
      <div className="container-page mt-10 flex flex-col gap-3 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-end">
        {/*
