      ...
      <div className="mt-8 overflow-hidden rounded-2xl border border-ink-100 bg-white shadow-[0_1px_3px_rgb(23_24_26_/_0.08)]">
        {video ? (
          ...
          <video
            ...
            controls
            /*
             * Ни байта до нажатия. С заставкой это ничего не стоит:
             * место занято настоящим кадром, а не пустотой, и человек
             * решает, смотреть ли, до того как за него что-то скачали.
             */
            preload="none"
            playsInline
