      ...
      <section>
        <div className="card">
          ...
          <p className="mt-3 max-w-[78ch] text-[15px] leading-relaxed text-ink-700">
            Сроки здесь — намерения, а не обязательства. Платформа находится на этапе прототипа,
            и карта, написанная как договор, была бы договором, который никто не может выполнить.
