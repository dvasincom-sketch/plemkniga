    ...
    <div className="space-y-10">
      ...
      <section>
        ...
        <div className="card mt-4 max-w-[80ch] space-y-4 text-[15px] leading-relaxed text-ink-700">
          <p>
            <strong className="font-medium text-ink-900">Что выгрузка работает целиком.</strong>{' '}
            Два шаблона — «Лактация» и «Родословная» — уже собираются файлом, и заголовки
            в них сверены с настоящими шаблонами реестра, а не переписаны на слух. Но кнопки
            в кабинете пока нет, файл собирается командой, и ни один такой файл ещё не был
            принят реестром: сказать, примет ли он его, может только настоящая отправка.
          </p>
          <p>
