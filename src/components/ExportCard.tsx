 ...
 *
 * XLSX с тех пор появился по-настоящему, и появился не ради того текста,
 * а ради колонки номера: Excel, открывая CSV, читает `0987654321` числом
 * и теряет ведущий ноль. Разбор — в `src/lib/export-formats.ts`. PDF
 * не появился и не появится, и там же сказано почему.
 *
...
export function ExportCard() {
  ...
  return (
    ...
    <div id="export" className="card flex h-fit scroll-mt-8 items-start justify-between gap-4">
