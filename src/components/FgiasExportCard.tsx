...
export function FgiasExportCard() {
  ...
  return (
    <div id="fgias" className="card scroll-mt-8">
      ...
      <div className="mt-5">
        ...
        {open && (
          <div className="mt-4">
            ...
            {/*
               Порядок работ, а не подсказка про формат. Вопрос «почему
               файл пустой» задают письмом ровно потому, что этой
               последовательности нигде не написано.
            */}
            <div className="mt-5 max-w-[80ch] space-y-2 text-[13px] leading-snug text-ink-500">
              <p className="font-medium text-ink-700">Порядок такой:</p>
              <p>
            ...
            <p className="mt-4 max-w-[80ch] text-[13px] leading-snug text-ink-500">
