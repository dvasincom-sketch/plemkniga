...
export default async function ChecksPage() {
   ...
   * в чужой кабинет: «Стадо», «Данные», «Хозяйство» — приглашения,
      ...
      <main className="container-page pb-8">
        ...
        <div className="min-w-0">
          ...
          {/*
             ...
             прогона — и заставлять ради него пролистывать полсотни
             правил значит прятать главное действие за справкой.
             (Числом здесь не называем: правил становится больше,
             а комментарий за ними не поспевает — так и вышло, когда
             двадцать шесть незаметно стали пятьюдесятью пятью.)
