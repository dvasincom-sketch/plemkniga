...
export default async function CalendarPage() {
  ...
  const nothing =
    !data || (data.dryOff.length === 0 && data.calving.length === 0 && data.pregCheck.length === 0)
            ...
            <Section
              ...
              why={
                <>
                  ...
                  <p>
                    «Яловая» попадает сюда наравне с непроставленным результатом: она
                    тоже требует решения — осеменять заново. Уходит строка тогда, когда
