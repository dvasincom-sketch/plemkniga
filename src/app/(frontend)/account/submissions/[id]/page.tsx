        ...
        <section className="mt-6">
          <div className="card px-8 py-9 sm:px-10">
            ...
            */}
            ...
            {/*
               Записи пакета: без списка «данные приняты» остаётся отвлечённой
               фразой — непонятно, о каких животных речь. Уровень достоверности
               публикация не трогает, подпись ставится по заявке на верификацию.
            */}
