            ...
            <>
              ...
              <section className="mt-8">
                <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                  ...
                  <Stat
                    ...
                    note={`В Великобритании ${AFC_REFERENCE_META.meanAfc}`}
                  />
                  <Stat
                    label="Медиана, мес."
                    value={mo(stats.medianAfc)}
                    note={`В Великобритании ${AFC_REFERENCE_META.medianAfc}`}
                  />
                  <Stat
                    label="Отелились до 24 мес."
                    value={pct(stats.shareEarly)}
                    note={`Старше 30 месяцев — ${pct(stats.shareLate)}. В Великобритании 12,2 % и 40,9 %`}
                  />
                </div>
              </section>
              ...
              <section className="mt-10">
                  ...
                  <table className="metric-table min-w-[620px]">
                    <thead>
                      <tr>
                        ...
                        <th className="text-right">В Великобритании</th>
                ...
                <p className="mt-4 max-w-[80ch] text-[13px] leading-relaxed text-ink-500">
                  Колонка «В Великобритании» — распределение 396 471 коровы из набора
                  Истхэма (2006–2008, {AFC_REFERENCE_META.herds} хозяйств, лицензия CC0),
                  ...
                  в соседних колонках — ваши собственные; британские сюда не вынесены
