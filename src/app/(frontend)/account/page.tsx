        ...
        <div>
          <div className="min-w-0">
            ...
            */}
            ...
            {/*
               Плашка говорит про заявку и только про неё.

               Прежде она обещала, что «до подтверждения данные видны
               только вам». Это неправда дважды: признак `confirmed`
               не участвует ни в одном правиле доступа, а видимость
               животных решает сам владелец флажком публичности. Плашка
               успокаивала тем, чего не делает, — а рядом стоит плашка
               членства, которая называет настоящие последствия.
            */}
            {!user.confirmed && (
              <p className="mt-5 rounded-xl bg-brand-50 px-5 py-4 text-sm text-forest-600">
                Регистрация завершена. Заявка на подтверждение учётной записи отправлена
                в Ассоциацию. Работать можно уже сейчас: что видно посторонним, решаете вы
                сами — флажком публичности у животного.
              </p>
            )}
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="card">
            ...
            <p className="max-w-[80ch] text-[15px] leading-relaxed text-ink-700">
              ...
              и кого осеменять заново. Посчитано из отёлов и осеменений, которые
