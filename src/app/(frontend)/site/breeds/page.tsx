...
import { DEMO_URL, PRODUCT_MAIL } from '@/lib/hosts'
...
export default async function BreedsPage() {
  const rows = await loadBreedCatalog()
    ...
    <>
      ...
      <main className="container-page pb-16">
        <section className="max-w-[75ch] pt-6">
          <p className="text-[14px] uppercase tracking-wide text-forest-500">Породы</p>
        ...
        <section className="mt-12 max-w-[75ch] rounded-2xl bg-forest-500 p-8 text-white sm:p-10">
          ...
          <p className="mt-4 text-[16px] leading-relaxed text-white/85">
            ...
            по своему адресу, с проверками, правами доступа и выгрузками в реестр; до этого
            устройство можно посмотреть на показательной книге.
          </p>
