        ...
        */}
        <section className="mt-14 max-w-[75ch]">
          <h2 className="text-[24px] font-medium leading-tight sm:text-[28px]">
            Кто в России ведёт племенные книги
          </h2>

          <p className="mt-5 text-[16px] leading-relaxed text-ink-700">
            Государство. Государственные племенные книги ведёт ВНИИплем — институт
            Министерства сельского хозяйства, — и там же публикуются сводные данные
            по породам. Это отличает нас от Европы, где книгу ведёт породное общество:
            объединение заводчиков само записывает животных, само выпускает документы
            и само отвечает за качество записей.
          </p>

          <p className="mt-4 text-[16px] leading-relaxed text-ink-700">
            Породные объединения при этом существуют и здесь: Ассоциация производителей
            КРС голштинской породы — объединение хозяйств, и её книга открыта по ссылке
            в таблице выше. Просто законом такая книга не предусмотрена как основная,
            и объединение ведёт её по собственному решению.
          </p>

          <p className="mt-4 text-[16px] leading-relaxed text-ink-700">
            Отсюда и состояние списка. У породы может быть государственный учёт и не быть
            книги, которую кто-то ведёт как живой инструмент: с проверками, документами
            и оценкой. Наше дело — сделать так, чтобы завести такую книгу можно было
            за неделю, а не за пять лет; чьей она будет, решает не платформа.
          </p>
        </section>
